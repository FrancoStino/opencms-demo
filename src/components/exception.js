  ...
  return (
    <div className="text-center py-16 animate-fade-in">
      ...
      <div className="relative mb-8">
        <div className="w-24 h-24 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-3xl shadow-2xl mx-auto flex items-center justify-center animate-pulse-slow">
        ...
        {/* Warning rings */}
        <div className="absolute inset-0 rounded-3xl border-4 border-transparent border-t-yellow-400 animate-spin opacity-30"></div>
        <div className="absolute inset-2 rounded-2xl border-4 border-transparent border-t-orange-400 animate-spin opacity-20" style={{animationDirection: 'reverse', animationDuration: '3s'}}></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Notice card */}
        <div className="glass-card bg-yellow-50/80 dark:bg-yellow-900/20 backdrop-blur-xl border-yellow-200/50 dark:border-yellow-800/50">
          <div className="flex items-start gap-4">
            ...
            <div className="text-left">
              ...
              <p className="text-yellow-700 dark:text-yellow-300 leading-relaxed">
                Per utilizzare questa demo, devi prima attivare l'API JSON di OpenCms seguendo i passaggi qui sotto.
              </p>
            </div>
          </div>
        </div>
...
[...]`
              ...
              <div key={index} className="flex gap-4 p-4 bg-white/40 dark:bg-gray-800/40 rounded-xl border border-gray-200/50 dark:border-gray-700/50">
                <div className="w-8 h-8 bg-gradient-to-br from-accent-500 to-accent-600 rounded-lg flex items-center justify-center flex-shrink-0 font-bold text-white">
                  {item.step}
                </div>
                <div className="flex-1">
                  ...
                  {item.code && (
                    <pre className="p-4 bg-gray-900 dark:bg-gray-950 text-green-400 rounded-lg text-sm overflow-x-auto border border-gray-700">
                      <code>{item.code}</code>
                    </pre>
                  )}
                </div>
