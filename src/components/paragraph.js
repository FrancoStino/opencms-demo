...
const Paragraph = ({ demo, content }) => {
  if (!content) {
    return null;
  }

  const { Caption, Image: imageContent, Text, Title } = content;
      ...
      {imageContent && (
        <div className="my-10">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-primary-500/10 to-secondary-500/10 rounded-2xl transform rotate-1 group-hover:rotate-2 transition-transform duration-300"></div>
            <Image 
              demo={demo} 
